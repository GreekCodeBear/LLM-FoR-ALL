...
from utils import find_files,formatting_prompts_func,print_trainable_parameters
...
model_path = "results/pt/checkpoint-10000"
...
# 加载数据集并进行预处理
directories = ["Gen","7M"]
data_files = find_files(directories,"data/sft")
